...
(defn run
  [run-filename]
  (let [korma-database-specification (create-database-specification)]
    (create-database korma-database-specification)
    (let [run-config-file (read-config-file run-filename)
          ...
          hdm-model (apply-resolved-function "create-model" hdm-model-namespace hdm-config korma-database-specification)]
    ...
    (remove-database korma-database-specification)))
